...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String string = Utilities.getSharedPreferences(MainActivity.this).getString("test", "");

        String string1  =Environment.getExternalStorageDirectory().getPath()+string ;

        try {
//            asyncRecognizeGcs(string1);
        } catch (Exception e) {
            e.printStackTrace();
        }
